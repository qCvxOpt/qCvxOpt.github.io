...
I am a faculty member at [Beijing Institute of Technology (BIT)](https://www.bit.edu.cn). 
I got...
...
**Research Interests:**
My research is concerned with the efficient and reliable characterization, verification, and validation (QCVV) of quantum states, processes, and devices, and with using tools such as convex optimization, semidefinite programming, compressed sensing, and modern Monte Carlo to make these tasks practical.
...
For a full list, organized by year or by category, see the [publications page](/publications/).
...
- [Google Scholar]
- [GitHub: qCvxOpt](https://github.com/qCvxOpt)
- Email: `jiangwei.shang [at] bit.edu.cn`
- [IWQCVV workshop series](https://iwqcvv.org/)
